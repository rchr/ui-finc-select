...
describe('Metadata Collection', () => {
  ...
  describe('check the collection filter elements', function () {
    it('mdSource filter should be present', () => {
      expect(collectionInteractor.sourceFilterIsPresent).to.be.true;
    });
    ...
    it('permitted filter should be present', () => {
      expect(collectionInteractor.permittedFilterIsPresent).to.be.true;
    });

    it('selected filter should be present', () => {
      expect(collectionInteractor.selectedFilterIsPresent).to.be.true;
    });
