const urls = {
  ...
  showAllCollections: (sourceId) => `/finc-select/metadata-collections?filters=mdSource.${sourceId},selected.yes,selected.no,permitted.yes,permitted.no,freeContent.undetermined,freeContent.no,freeContent.yes`,
  // showSelectedCollections: (sourceId) => `/finc-select/metadata-collections?filters=mdSource.${sourceId},selected.yes`,
  showSelectedCollections: (sourceId) => `/finc-select/metadata-collections?filters=mdSource.${sourceId},selected.yes,permitted.yes,permitted.no,freeContent.undetermined,freeContent.no,freeContent.yes`,
